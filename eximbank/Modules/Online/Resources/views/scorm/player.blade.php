...
<script type="text/javascript">
    ...
    (function ($) {
        ...
        function setupScormApi() {
            ...
            obj.setAttribute('src', '/online/scorm/redirect?scoid={{ $activity->id }}&mode=&attempt={{ $attempt ? $attempt->id : 0 }}');
        ...
        function LMSInitialize(initializeInput) {
            ...
            @if($attempt && $attempt->suspend_data)
        ...
        function LMSSetValue(varname, varvalue) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    attempt: '{{ $attempt ? $attempt->id : 0 }}',
                    scoid: '{{ $activity->id }}',
                    varname: varname,
                    varvalue: varvalue,
                    preview: '{{ isset($preview) ? $preview : 0 }}',
                },
