...
class CreateElDashboardUnitOfflineCourseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_dashboard_unit_offline_course', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_dashboard_unit_offline_course');
    }
}
