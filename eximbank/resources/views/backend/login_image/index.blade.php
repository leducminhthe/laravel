...
@section('page_title', trans('lasetting.login_wallpaper'))
@section('header')
                    ...
                    <div class="modal-body" id="body_modal">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3 control-label">
                                <label for="image">{{trans('lasetting.picture')}} <span class="text-danger">*</span> <br>({{trans('lasetting.size')}}: 2000x1000)</label>
                            </div>
                            <div class="col-sm-5">
