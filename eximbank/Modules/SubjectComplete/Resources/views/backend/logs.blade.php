...
@section('page_title', trans('lamenu.subject_complete'))
...
@section('breadcrumb')
    @php
        $breadcum= [
            ...
            [
                'name' => trans('lamenu.subject_complete'). ': '. trans('latraining.logs_subject_complete'),
                'url' => ''
            ],
        ]
    @endphp
...
@section('content')
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('module.subjectcomplete.logs.getData') }}',
        });
