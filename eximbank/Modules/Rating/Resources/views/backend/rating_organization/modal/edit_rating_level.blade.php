    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-rating" action="{{ route('module.rating_organization.save_rating_course', [$item->id, $rating_level_course->course_rating_level_id, $user_id, $rating_user]) }}" method="post" class="form-validate form-ajax" role="form" enctype="multipart/form-data">
