  ...
  <div class="col-md-4">
    <div class="text-center">
      ...
      <div class="btn-group clearfix">
        <label class="btn btn-aspectRatio active" onclick="changeAspectRatio(this, 16 / 9)">
          16:9
        </label>
        <label class="btn btn-aspectRatio" onclick="changeAspectRatio(this, 4 / 3)">
          4:3
        </label>
        <label class="btn btn-aspectRatio" onclick="changeAspectRatio(this, 1)">
          1:1
        </label>
        <label class="btn btn-aspectRatio" onclick="changeAspectRatio(this, 2 / 3)">
          2:3
        </label>
        {{--<label class="btn" onclick="changeAspectRatio(this, null)">
          Free
        </label>--}}
      </div>
      <br>
      ...
      <button class="btn" onclick="performCrop()">{{ trans('laravel-filemanager::lfm.btn-crop') }}</button>
      <button class="btn" onclick="performCropNew()">{{ trans('laravel-filemanager::lfm.btn-copy-crop') }}</button>
      <button class="btn" onclick="loadItems()">{{ trans('laravel-filemanager::lfm.btn-cancel') }}</button>
      <form id='cropForm'>
