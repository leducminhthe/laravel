...
<head>
    ...
    {{-- Styles --}}
    <link rel="stylesheet" href="{{ asset('css/maxcdn_v4_bootstrap.min.css') }}" >
    <link rel="stylesheet" href="{{ asset('css/maxcdn_v4_font-awesome.min.css') }}">
...
<body>
    ...
    <script src="{{ asset('js/cdnjs_cloudflare_v1.12.9_popper.min.js') }}" crossorigin="anonymous"></script>
    <script src="{{ asset('js/maxcdn_v4_bootstrap.min.js') }}" crossorigin="anonymous"></script>
    <script src="{{ asset('js/cdnjs_cloudflare_v2.7.1_Chart.min.js') }}"></script>
