<form method="POST" action="{{ route('module.libraries.document.save') }}" class="form-validate form-ajax" role="form" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <div class="btn-group act-btns">
                @canany(['libraries-document-create', 'libraries-document-edit'])
                    <button type="submit" class="btn" data-must-checked="false"><i class="fa fa-save"></i> &nbsp;{{ trans('labutton.save') }}</button>
                @endcanany
                <a href="{{ route('module.libraries.document') }}" class="btn"><i class="fa fa-times-circle"></i> {{ trans('labutton.cancel') }}</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group row">
                <div class="col-sm-3 control-label">
                    <label for="category_id">{{trans("backend.document_category")}} <span class="text-danger">*</span></label>
                </div>
                <div class="col-md-6">
                    <select name="category_id" id="category_id" class="form-control select2"
                            data-placeholder="--{{trans("backend.document_category")}}--" required>
                        <option value=""></option>
            ...
            <div class="form-group row">
                <div class="col-sm-3 control-label">
                    <label for="name_author">{{ trans('lalibrary.drafting_source') }} <span class="text-danger">*</span></label>
                </div>
                <div class="col-md-6">
                    <input name="name_author" type="text" class="form-control" placeholder="--{{ trans('lalibrary.drafting_source') }}--" value="{{ $model->name_author }}" required>
                </div>
            </div>
