...
@section('content')
    <div class="container-fluid mt-2 p-1" id="rating_level">
        <form action="{{ route('themes.mobile.frontend.offline.detail.rating_teacher.save', [$item->id]) }}" method="post" class="form-validate form-ajax" role="form" enctype="multipart/form-data">
                                                                    ...
                                                                    @foreach($answers as $ans_key => $answer)
                                                                        ...
                                                                        <th class="text-center border-top-0 w-auto">
                                                                            ...
                                                                            <label for="is_check{{$answer->id}}_teacher{{ $teacher->id }}" class="mb-0">
                                                                                <img src="/images/heart_1.png" class="image_choose img_{{ $ans_key }}" onclick="checkRankQuestionTeacher({{ $ans_key }},{{ $question->id }}, {{ $teacher->id }})"
                                                                ...
                                                                @foreach($answers as $ans_key => $answer)
                                                                    ...
                                                                    <th class="text-center border-top-0 w-auto">
                                                                        ...
                                                                        <label for="is_check{{$answer->id}}" class="mb-0">
                                                                            <img src="/images/heart_1.png" class="image_choose img_{{ $ans_key }}" onclick="checkRankQuestion({{ $ans_key }},{{ $question->id }})"
                                                                            height="20px" width="20px">
                                                                            <br>
                                                                            {{ $answer->name }}
                                                                        </label>
