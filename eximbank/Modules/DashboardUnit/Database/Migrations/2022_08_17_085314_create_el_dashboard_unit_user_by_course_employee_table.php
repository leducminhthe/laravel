...
class CreateElDashboardUnitUserByCourseEmployeeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_dashboard_unit_user_by_course_employee', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_dashboard_unit_user_by_course_employee');
    }
}
