            ...
            <form id="frm-save-approve" class="form-horizontal" method="post" action="{{route('backend.permission.approved.save')}}" role="form" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="approve_all_child" id="approve_all_child" value="0">
                ...
                <div class="modal-footer">
                    ...
                    <button id="save-approved" class="btn"><i class="fa fa-save"></i> {{trans('labutton.save')}}</button>
                </div>
            </form>
        </div>
    </div>
