...
class CreateOfflineCourseActivityXapiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('offline_course_activity_xapi', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('offline_course_activity_xapi');
    }
}
