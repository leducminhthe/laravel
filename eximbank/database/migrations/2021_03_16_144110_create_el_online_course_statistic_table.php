...
class CreateElOnlineCourseStatisticTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_online_course_statistic', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_online_course_statistic');
    }
}
