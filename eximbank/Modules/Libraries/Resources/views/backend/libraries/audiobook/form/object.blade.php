<div class="row">
    ...
    <form method="post" action="{{ route('module.libraries.audiobook.save_object', ['id' => $model->id]) }}" class="form-horizontal form-ajax" role="form" enctype="multipart/form-data" data-success="submit_success">
        <div id="object-unit">
            <div class="form-group row">
                <div class="col-sm-3 control-label">
...
var table = new LoadBootstrapTable({
    ...
    url: '{{ route('module.libraries.audiobook.get_object', ['id' => $model->id]) }}',
    remove_url: '{{ route('module.libraries.audiobook.remove_object', ['id' => $model->id]) }}'
});

var table_user = new LoadBootstrapTable({
    url: '{{ route('module.libraries.audiobook.get_user_object', ['id' => $model->id]) }}',
    remove_url: '{{ route('module.libraries.audiobook.remove_object', ['id' => $model->id]) }}',
