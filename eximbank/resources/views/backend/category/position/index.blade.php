...
@section('page_title', trans('lacategory.position'))
...
@section('content')
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('backend.category.position.getdata') }}',
            remove_url: '{{ route('backend.category.position.remove') }}',
            sort_name: 'id'
        });
        ...
        function changeStatus(id,status) {
            ...
            $.ajax({
                url: "{{ route('backend.category.position.ajax_isopen_publish') }}",
                type: 'post',
                data: {
                    ids: ids,
                    status: status
        ...
        function edit(id){
            ...
            $.ajax({
                url: "{{ route('backend.category.position.edit') }}",
                type: 'post',
                data: {
                    id: id,
                }
        ...
        function save(event) {
            ...
            $.ajax({
                url: "{{ route('backend.category.position.save') }}",
                type: 'post',
                data: {
                    'name': name,
                    'code': code,
        ...
        function create() {
            $('#exampleModalLabel').html('Thêm chức vụ');
