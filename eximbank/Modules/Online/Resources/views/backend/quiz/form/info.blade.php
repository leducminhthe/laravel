<form method="post" action="{{ route('module.online.quiz.save', ['course_id' => $course_id]) }}" class="form-validate form-ajax" role="form" enctype="multipart/form-data">
        ...
        <div class="col-md-3">
            <div class="form-group text-right">
                <div class="btn-group act-btns">
                    ...
                    @endif
                        <a href="{{ route('module.online.quiz', ['course_id' => $course_id]) }}" class="btn"><i class="fa fa-times-circle"></i> {{ trans('labutton.cancel') }}</a>
                </div>
            </div>
            <p></p>
            ...
            {{-- <div class="form-group">
                <label for="exam_form">{{trans('latraining.quiz_form')}} <span class="text-danger">*</span></label>
                <select name="quiz_type" id="quiz_type" class="form-control select2" data-placeholder="{{trans('latraining.choose_form')}}" required>
                    <option value="1" selected> {{trans('latraining.online')}}</option>
                </select>
            </div> --}}
