...
class BC38Export implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize,  WithEvents, WithStartRow, WithCharts
{
    ...
    public function map($report): array
    {
        ...
        return [
            $this->index,
            $report->name,
            BC38::countViewVideoInMonth($report->id)
        ];
    }
    ...
    {
        return [
            ['BÁO CÁO THỐNG KÊ SỐ LƯỢNG NGƯỜI XEM VIDEO CỦA ĐƠN VỊ CÓ VIDEO XUẤT BẢN TRONG THÁNG'],
            [],
            [
                trans('latraining.stt'),
               trans('latraining.unit'),
                'Số lượng xem video trong tháng',
            ]
        ];
    }
    ...
    public function charts() {
        ...
        $title = new Title('SỐ LƯỢNG XEM VIDEO CỦA ĐƠN VỊ XUẤT BẢN TRONG THÁNG');
