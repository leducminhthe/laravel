...
<body>
                    ...
                    <div class="col-sm-5">
                        <form action="{{URL::to('tim-kiem')}}" method="post">
                            ...
                            <div class="search_box pull-right">
                                ...
                                <input type="submit" name="search_item" class="btn btn-success btn-sm" value="Search">
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v7.0" nonce="yNO77Oy0"></script>
</body>
</html>