    ...
    <table id="bootstraptable" class="tDefault table table-hover table-bordered bootstrap-table" data-url="{{route('module.report_new.getData')}}">
        <thead>
            <tr class="tbl-heading">
                ...
                <th data-field="question_name">{{trans('lareport.question')}}</th>
                <th data-field="num_question_used" data-align="center">{{trans('lareport.num_times_use_exam_question')}}</th>
                <th data-field="percent_right" data-align="center">{{trans('lareport.correct_answer_rate')}}</th>
                <th data-field="text_question_type" data-align="center">{{trans('lareport.type_question')}}</th>
            </tr>
        </thead>
    </table>
</div>
