...
class CreateElRatingLevelCourseQuestionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_rating_level_course_question', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_rating_level_course_question');
    }
}
