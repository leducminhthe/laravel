<div class="row">
    <div class="col-md-9">
    @if($permission_save)
        <form method="post" action="{{ route('module.online.rating_level.save', ['course_id' => $model->id]) }}" class="form-ajax" id="form-rating-level" data-success="submit_success_rating_level">
...
<script type="text/javascript">
    ...
    var table_rating_level = new LoadBootstrapTable({
        ...
        url: '{{ route('module.online.rating_level.getData', ['course_id' => $model->id]) }}',
        remove_url: '{{ route('module.online.rating_level.remove', ['course_id' => $model->id]) }}',
