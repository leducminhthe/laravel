        ...
        <div class="col-md-4 text-right">
            <div class="btn-group act-btns">
                @canany(['libraries-video-create', 'libraries-video-edit'])
                    <a style="cursor: pointer" id="add_more_video" onclick="addMoreVideos()" class="btn"><i class="fa fa-plus-circle"></i> &nbsp;{{ trans('labutton.add_video') }}</a>
                    <button type="submit" class="btn" data-must-checked="false"><i class="fa fa-save"></i> &nbsp;{{ trans('labutton.save') }}</button>
                @endcanany
                <a href="{{ route('module.libraries.video') }}" class="btn"><i class="fa fa-times-circle"></i> {{ trans('labutton.cancel') }}</a>
            </div>
        </div>
    </div>
    <div class="row">
                ...
                @if (isset($videos))
                    ...
                    <div class="form-group row" id="{{$video->id}}">
                        ...
                        <div class="col-sm-2 control-label">
                            <a style="cursor: pointer" id="close_add_videos" onclick="closeAddVideos({{$video->id}})" class="btn">Xóa</a>
                        </div>
                    </div>
                    @endforeach
                @endif
