...
|
*/
// $targetFile=explode("\\", $CFG->dataroot);
// 		$targetFile =implode($targetFile, '/');
// 		echo $targetFile; die;
//echo $CFG->dataroot; die;
...
$config = array(
	...
	*/
	...
	//'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://'.$_SERVER['SERVER_NAME'].'',
	'base_url' => $CFG->wwwfiledata, //'http://ttcdatafile.toplearning.vn',
	...
	*/
	...
	|
	*/
	//'current_path' => '/var/www/html/lmsvccb/tfiles/uploadFiles/',
	//'current_path' => 'J:/xampp/htdocs/vccb_dev/tfiles/uploadFiles/',
	//'current_path' => '/home/web/datafile/ttcdatafile/tfiles/uploadFiles/',
	'current_path' => $CFG->dataroot.'/tfiles/uploadFiles/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	//'thumbs_base_path' => '../gfiles-thumbs/',
	'thumbs_base_path' => $CFG->dataroot.'/tfiles/uploadFiles/gfiles-thumbs/',
	'thumbs_base_path_relative' => $CFG->wwwfiledata.'/tfiles/uploadFiles/gfiles-thumbs/',
	//'thumbs_base_path_relative' =>'',
	/*
	|--------------------------------------------------------------------------
	| Access keys
	|--------------------------------------------------------------------------
	...
	*/
	...
	'access_keys' => array('3df199403c395007d955476a62dfd3c2'),
	//'access_keys' => array(hash('sha256',md5(md5($USER->username).$USER->id))),
