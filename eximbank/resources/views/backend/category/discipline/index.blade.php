...
@section('page_title', @trans('lacategory.violator_list'))
...
@section('content')
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('backend.category.discipline.getdata') }}',
            remove_url: '{{ route('backend.category.discipline.remove') }}',
            sort_name: 'id'
        });
        ...
        function changeStatus(id,status) {
            ...
            $.ajax({
                url: "{{ route('backend.category.discipline.ajax_isopen_publish') }}",
                type: 'post',
                data: {
                    ids: ids,
                    status: status
        ...
        function edit(id){
            ...
            $.ajax({
                url: "{{ route('backend.category.discipline.edit') }}",
                type: 'post',
                data: {
                    id: id,
                }
        ...
        function save(event) {
            ...
            $.ajax({
                url: "{{ route('backend.category.discipline.save') }}",
                type: 'post',
                data: {
                    'name': name,
                    'code': code,
        ...
        function create() {
            ...
            $("input[name=id]").val('');
            $("input[name=code]").val('');
            $('#exampleModalLabel').html('Thêm vi phạm');
            $('#modal-popup').modal();
        }
    </script>
@endsection
