        ...
        <form method="post" action="{{ route('module.capabilities.save') }}" class="form-validate form-ajax" role="form" enctype="multipart/form-data">
            ...
            <div class="tPanel">
                <ul class="nav nav-pills mb-4" role="tablist" id="mTab">
                    ...
                    <li class="nav-item"><a href="#dictionary" class="nav-link @if($tabs == 'dictionary') active @endif" data-toggle="tab">{{trans('backend.library')}}</a></li>
                </ul>
