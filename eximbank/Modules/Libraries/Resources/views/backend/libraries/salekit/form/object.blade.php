<form method="post" action="{{ route('module.libraries.salekit.save_object', ['id' => $model->id]) }}" class="form-horizontal form-ajax" role="form" enctype="multipart/form-data" data-success="submit_success">
   <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div id="object-user">
                <div class="form-group row">
                    <div class="col-md-3"></div>
                    <div class="col-md-9">
                        <a class="btn" href="{{ download_template('mau_import_nhan_vien_thu_vien.xlsx') }}"><i class="fa
                        fa-download"></i> {{trans('labutton.import_template')}}</a>
...
<div class="modal fade" id="modal-import" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <form action="{{ route('module.libraries.salekit.import_object', ['id' => $model->id]) }}" method="post" class="form-ajax">
...
<script type="text/javascript">
    var table = new LoadBootstrapTable({
        ...
        url: '{{ route('module.libraries.salekit.get_object', [$model->id]) }}',
        remove_url: '{{ route('module.libraries.salekit.remove_object', [$model->id]) }}',
        detete_button: '#delete-unit-title',
        table: '#table-unit-title-object',
    });

    var table_user = new LoadBootstrapTable({
        url: '{{ route('module.libraries.salekit.get_user_object', [$model->id]) }}',
        remove_url: '{{ route('module.libraries.salekit.remove_object', [$model->id]) }}',
