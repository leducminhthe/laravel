...
class DocumentController extends Controller
{
    ...
    {
        $categories = LibrariesCategory::select(['id','name'])->where('type', '=', 3)->get();
    ...
    public function treeFolder() {
        ...
        $route = route('module.libraries.document');
        $corporations = LibrariesCategory::select(['id','name','type'])->where('type', '=', 3)->whereNull('parent_id')->get();
