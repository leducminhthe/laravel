<div role="main">
    ...
    <table class="tDefault table table-hover bootstrap-table" id="all_course_teaching">
        <thead>
            <tr>
...
<script type="text/javascript">
    ...
    var table = new LoadBootstrapTable({
        ...
        url: '{{ route('backend.category.training_teacher.list_course_teacher_getdata',[ 'type' => 1]) }}',
        table: "#all_course_teaching",
