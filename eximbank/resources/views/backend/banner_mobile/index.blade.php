...
@section('page_title', trans('lasetting.banner_login_mobile'))
...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-right act-btns">
                <div class="pull-right">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('backend.banner_login_mobile.create') }}" class="btn"><i class="fa fa-plus-circle"></i> {{ trans('labutton.add_new') }}</a>
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('backend.banner_login_mobile.getdata') }}',
            remove_url: '{{ route('backend.banner_login_mobile.remove') }}'
        });
        ...
        function changeStatus(id,status) {
            ...
            $.ajax({
                url: "{{ route('backend.banner_login_mobile.ajax_isopen_publish') }}",
                type: 'post',
                data: {
                    ids: ids,
                    status: status
