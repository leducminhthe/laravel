...
class CreateElMailTemplateTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_mail_template', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_mail_template');
    }

    public function insertData() {
        \DB::table('el_mail_template')->insert([
            [
                'code' => 'registered_course',
                'name' => 'Thông báo đã được duyệt ghi danh khóa học',
                'title' => '{gender} {firstname} vừa được ghi danh vào khóa học {course_name} (Mã khóa học: {course_code})',
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>{gender} {firstname} vừa được ghi danh khóa học {course_name} (Mã khóa học: {course_code}).</p>
                    ...
                    <p>Nào, hãy sắp xếp lại kế hoạch và công việc của {gender} {firstname} để tham gia đầy đủ và hoàn thành khóa học {gender} {firstname} nhé.</p>
            ...
            [
                ...
                'title' => '{gender} {firstname} thuộc đối tượng tham gia, đăng ký khóa học {course_name} (Mã khóa học: {course_code})',
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>{gender} {firstname} thuộc đối tượng tham gia, đăng ký khóa học {course_name} (Mã khóa học: {course_code}).</p>
                    <p>- Thời gian: {start_date} - {end_date}.</p>
                    <p>- Ngày bắt đầu học là {start_date}</p>
                    <p>- Địa điểm: {training_location}</p>
                    <p>- Hình thức: {course_type}</p>
                    <p>Nào, hãy sắp xếp lại kế hoạch và công việc của {gender} {firstname} để đăng ký khóa học.</p>
                    <p>Vui lòng bấm vào {url} để xem chi tiết khóa học.</p>
                    <p>Chúc {gender} {firstname} hoàn thành khóa học với kết quả cao nhất!</p>
                    <p>Trân trọng.</p>',
            ...
            [
                ...
                'content' => '<p>Chào {Gender} {FirstName}</p>
                    ...
                    <p>Chúc {Gender} {FirstName} hoàn thành khóa học với kết quả cao nhất!</p>
                    <p>Trân trọng.</p>',
                'note' => 'Khóa học offline với các hoạt động chưa đủ 100%. Học viên nằm trong danh sách đã duyệt'
            ],
            [
                ...
                'content' => '<p>Chào {Gender} {FirstName}</p>
                    ...
                    <p>Trân trọng.</p>',
                'note' => 'Khóa học offline với các hoạt động chưa đủ 100%. Học viên nằm trong danh sách đã duyệt. Ngày tham gia hoạt động cuối cùng so với ngày hiện tại là [[A]]'
            ],
            [
                ...
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>Xin chúc mừng {gender} {firstname} đã tham gia và hoàn thành các hoạt động/nội dung trong khóa học {course_name} (Mã khóa học: {course_code})</p>
                    <p>- Hình thức: {course_type}</p>
                    <p>- Ngày bắt đầu: {start_date}</p>
                    <p>- {gender} {firstname} đã hoàn thành là {progress}%</p>
                    <p>- Kết quả: {completion}</p>
                    <p>Lưu ý: Nếu khóa học của {gender} {firstname} có bắt buộc thực hiện bảng khảo sát hoặc Bảng đánh giá hiệu suất đào tạo thì {gender} {firstname} hãy thực hiện nhé.</p> 
                    <p>Chúc {gender} {firstname} có thể ứng dụng những kiến thức đã học một cách hiệu quả!</p>
                    <p>Trân trọng.</p>',
            ...
            [
                ...
                'title' => '{gender} {firstname} đã được ghi danh vào kỳ thi {quiz_name}',
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>{gender} {firstname} được ghi danh vào kỳ thi {quiz_name}</p>
                    ...
                    <p>Chúc {gender} {firstname} hoàn thành kỳ thi với kết quả cao nhất!</p>
                    <p>Trân trọng.</p>',
            ...
            [
                ...
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>{gender} {firstname} đã hoàn thành bài thi {quiz_name}</p>
            ...
            [
                ...
                'title' => 'Khóa học {course_name} của {gender} {firstname} đã bị xóa',
                'content' => '<p>Kính gửi thông báo đến {gender} {full_name}</p>
                    <p>Khóa học {course_name} mã khóa học: {course_code} của {gender} {firstname} đã bị xóa do thời gian bảo lưu đã hết hạn.</p>
                    <p>Trân trọng.</p>',
            ...
            [
                ...
                'content' => '<p>Chào {gender} {full_name}</p>
                    ...
                    <p>{gender} {firstname} sắp xếp thời gian để thực hiện bài Đánh giá hiệu quả đào tạo trong thời gian sớm nhất.</p>
            ...
            [
                ...
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>Hiện tại, Bộ phận đào tạo chưa thấy {gender} {firstname} thực hiện Đánh giá hiệu quả đào tạo {rating_name}.</p>
                    <p>Đề nghị {gender} {firstname} sắp xếp thời gian để thực hiện đánh giá hiệu quả đào tạo trong thời gian sớm nhất.</p>
            ...
            [
                ...
                'title' => '{gender} {firstname} đã hoàn thành Bảng đánh giá hiệu suất của khóa học {course_name}',
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>Xin chúc mừng, {gender} {firstname} đã hoàn thành Bảng đánh giá hiệu quả đào tạo của khóa học {course_name} {course_code} vào ngày {date_action_plan}</p>
                    <p>Trân trọng thông báo.</p>',
            ...
            [
                'code' => 'approve_book_register',
                'name' => 'Thông báo duyệt đăng ký mượn sách',
                'title' => 'Duyệt đăng ký mượn sách',
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>Đăng ký mượn sách {book_name} đã được duyệt. Vui lòng liên hệ người quản lý sách.</p>',
                'note' => 'Đối tượng nhận: Nhân sự được duyệt<br> Thời gian gửi: Sau khi nhân sự được duyệt đăng ký mượn sách.'
            ],
            [
                'code' => 'out_of_date_register_book',
                'name' => 'Thông báo quá hạn mượn sách',
                'title' => 'Quá hạn mượn sách',
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>Sách {book_name} đã quá hạn mượn vào ngày {pay_date}.</p>',
                'note' => 'Đối tượng nhận: Nhân sự mượn sách<br> Thời gian gửi: Sau khi quá hạn mượn sách.'
            ],
            [
                'code' => 'pay_date_register_book',
                'name' => 'Thông báo đến hạn trả sách',
                'title' => 'Đến hạn trả sách',
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>Sách {book_name}  cần được trả vào ngày {pay_date} Vui lòng liên hệ người quản lý sách để trả.</p>',
                'note' => 'Đối tượng nhận: Nhân sự đến hạn trả sách<br> Thời gian gửi: Sau khi nhân sự đến hạn trả sách.'
            ],
            [
                'code' => 'user_promotion_order',
                'name' => 'Thông báo quy đổi quà tặng',
                'title' => 'Quy đổi quà tặng',
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>Quà tặng {promotion_name} bạn đổi đã {promotion_status}.</p>',
                'note' => 'Đối tượng nhận: Học viên quy đổi quà tặng<br> Thời gian gửi: Sau khi quản trị viên duyệt.'
            ],
            [
                'code' => 'notify_course_deadline_1',
                'name' => 'Thông báo sắp đến hạn khóa học - Lần 1',
                'title' => 'Thông báo sắp đến hạn khóa học {course_name} - Lần 1',
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>{gender} {firstname} vừa được ghi danh khóa học {course_name} (Mã khóa học: {course_code}).</p>
                    <p>Khóa học {course_name} (Mã khóa học: {course_code}) sắp đến hạn kết thúc vào ngày {end_date}</p>
                    <p>Chỉ còn {so_ngay} là sẽ kết thúc khóa học.</p>
                    <p>{gender} {firstname} hãy nhanh chóng sắp xếp thời gian để hoàn tất bài học này.</p>
                    <p>Vui lòng bấm vào {url} để xem chi tiết khóa học.</p>
                    <p>Chúc {gender} {firstname} hoàn thành khóa học với kết quả cao nhất!</p>
                    <p>Trân trọng.</p>',
                'note' => 'Đối tượng nhận: Học viên <br> Thời gian gửi: Trước X ngày so với ngày kết thúc.'
            ],
            [
                'code' => 'notify_course_deadline_2',
                'name' => 'Thông báo sắp đến hạn khóa học - Lần 2',
                'title' => 'Thông báo sắp đến hạn khóa học {course_name} - Lần 2',
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>{gender} {firstname} vừa được ghi danh khóa học {course_name} (Mã khóa học: {course_code}).</p>
                    <p>Khóa học {course_name} (Mã khóa học: {course_code}) sắp đến hạn kết thúc vào ngày {end_date}</p>
                    <p>Chỉ còn {so_ngay} là sẽ kết thúc khóa học.</p>
            ...
            [
                'code' => 'notify_offline_schedule',
                'name' => 'Bạn có lịch giảng dạy dành cho giảng viên khóa học Tập trung',
                'title' => 'Bạn có lịch giảng dạy ngày {start_date} - {end_date} của khóa {course_name}',
                'content' => '<p>Chào {gender} {full_name}</p>
                    <p>{gender} {firstname} có khóa học sẽ tổ chức vào ngày {start_date}, {gender} {firstname} sắp xếp kế hoạch để tham gia giảng dạy theo đúng kế hoạch.</p>
                    <p>Trân trọng.</p>',
                'note' => 'Đối tượng nhận: Giảng viên trong khoá học Tập trung <br> Thời gian gửi: Trước X ngày so với ngày bắt đầu.'
            ],
            /*[
