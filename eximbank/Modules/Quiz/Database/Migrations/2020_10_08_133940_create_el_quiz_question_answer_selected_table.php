...
class CreateElQuizQuestionAnswerSelectedTable extends Migration
{
    public function up()
    {
        Schema::create('el_quiz_question_answer_selected', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_quiz_question_answer_selected');
    }
}
