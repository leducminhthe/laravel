    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ trans('lamenu.evaluate_training_effectiveness') }}</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form id="form-rating" action="{{ route('module.online.rating_level.save_rating_course', [$item->id, $rating_level_course->course_rating_level_id, $user_id, $rating_user]) }}" method="post" class="form-validate form-ajax" role="form" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <table class="table tDefault table-bordered">
                                <tr>
                                    <th><b>{{ trans('latraining.rating_name') }}: </b> {{ $rating_level->rating_name }}</th>
                                    <th></th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th><b>{{ trans('latraining.assessor') }}: </b> {{ $profile->full_name .' ('. $profile->code .')' }}</th>
                                    <th><b>{{ trans('latraining.evaluation_object') }}: </b> {{ $rating_level->object_rating == 1 ? 'Lớp học' : ($object_rating->full_name .' ('. $object_rating->code .')') }}</th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th><b>{{ trans('latraining.unit') }}: </b> {{ $profile->unit_name }}</th>
                                    <th> <b>{{ trans('latraining.unit') }}: </b> {{ $rating_level->object_rating == 1 ? '' : $object_rating->unit_name }}</th>
                                </tr>
                            </table>
                        </div>
                        <div class="card-body">
