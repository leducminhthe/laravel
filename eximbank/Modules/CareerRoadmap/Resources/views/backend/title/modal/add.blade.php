<div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="modal-title" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <form action="{{ route('module.career_roadmap.title.save', [$title->id]) }}" method="post" class="form-ajax">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="checkbox" name="primary" id="roadmap_primary" value="1">
                        <label for="roadmap_primary">@lang('lacareer_path.roadmap_primary')</label>
                    </div>
