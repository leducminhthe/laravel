<form id="form-schedule" action="{{ route('module.course_plan.save_schedule', ['course_type' => $course_type, 'id' => $model->id]) }}" method="post" class="form-ajax" data-success="submit_success_schedule">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select name="teacher_main_id" id="teacher_main_id" class="form-control select2" data-placeholder="{{ trans('backend.choose_main_lecturer') }}" required>
                        <option value=""></option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select name="teach_id" id="teach_id" class="form-control select2" data-placeholder="{{ trans('backend.choose_tutors') }}">
                        <option value=""></option>
                        @foreach($teachers as $teacher)
                            <option value="{{ $teacher->id }}"> {{ $teacher->name }}</option>
                        @endforeach
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            @can('course-plan-create-schedule')
...
<div class="row">
    <div class="col-md-12" id="schedule">
        <div class="text-right">
            @if ($model->status_convert != 1)
            @can('course-plan-delete-schedule')
...
<script type="text/javascript">
    ...
    var table_schedule = new LoadBootstrapTable({
        url: '{{ route('module.course_plan.get_schedule', ['course_type' => $course_type, 'id' => $model->id]) }}',
        remove_url: '{{ route('module.course_plan.remove_schedule', ['course_type' => $course_type, 'id' => $model->id]) }}',
