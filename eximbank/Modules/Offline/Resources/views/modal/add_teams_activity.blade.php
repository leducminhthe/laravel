<div class="modal fade modal-add-activity" id="myModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('module.offline.activity.save', [$course->id, 'activity' => 2]) }}" method="post" class="form-ajax">
                <input type="hidden" name="id" value="{{ $model->id }}">
                <input type="hidden" name="subject_id" value="{{ $model->subject_id }}">

                <div class="modal-header">
                    <h4 class="modal-title">{{trans('backend.activiti')}}: Miscrosoft Teams</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select name="class_id" id="class_id" disabled class="form-control select2" data-placeholder="{{ trans('latraining.class_name') }}">
                                <option value=""></option>
                                @if ($list_class)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select name="schedule_id" id="schedule_id" disabled class="form-control select2" data-placeholder="{{ trans('latraining.schedule') }}">
                                <option value=""></option>
                                @if ($schedule)
