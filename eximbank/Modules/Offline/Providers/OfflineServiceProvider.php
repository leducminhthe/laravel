...
class OfflineServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->commands([
            \Modules\Offline\Console\OfflineComplete::class,
            \Modules\Offline\Console\ReportTeams::class,
            \Modules\Offline\Console\SettingJoinOffline::class,
            \Modules\Offline\Console\UnzipScorm::class,
            \Modules\Offline\Console\UnzipXapi::class,
        ]);
    }
