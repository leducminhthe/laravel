...
class CreateElOrganizationStarTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_organization_star', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('el_organization_star');
    }
}
