...
use Modules\DashboardUnit\Entities\DashboardUnitCourseByTrainingForm;

class DashboardUnitCourseByTrainingFormCommand extends Command
{
    protected $signature = 'dashboard_unit_course_by_training_form:update';
    protected $description = 'Cập nhật Thống kê số lớp theo loại hình đào tạo (Dashboard đơn vị). Chạy lúc 23h (0 23 * * *)';
    ...
    public function handle()
    {
        ...
        foreach ($units as $unit){
            ...
            foreach ($training_form as $item) {
                ...
                $model = DashboardUnitCourseByTrainingForm::firstOrNew([
                    'unit_id' => $unit->id,
            ...
            $query_sum = DashboardUnitCourseByTrainingForm::where(['unit_id' => $unit->id,'year' => $year])
