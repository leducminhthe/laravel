                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <img src="{{ image_user($user->avatar) }}" alt="" class="rounded-circle" style="width: 100px;">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 mt-2">
                        ...
                        <div class="progress progress2">
                            <div class="progress-bar w-{{$percent}}" role="progressbar" style="width: {{ $percent }}%"
                    ...
                    <div class="col-md-12">
                        <h3 class="text-center title_color mt-2 mb-3">CHI TIẾT CÁC KHÓA HỌC THEO NĂNG LỰC CỦA BẠN</h3>
                            ...
                            @if($course_standard)
                                @foreach($course_standard as $key => $item)
                                    ...
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td class="text-left">
                                            {{ $item->capabilities_name .' - Cấp độ '. $item->standard_level .' ('. $item->capabilities_code . ')'  }}
                                            <br>
