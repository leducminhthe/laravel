...
class CreateElSettingJoinOnlineCourseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_setting_join_online_course', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_setting_join_online_course');
    }
}
