...
class CreateElOfflineRegisterViewTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_offline_register_view', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_offline_register_view');
    }
}
