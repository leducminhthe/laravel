...
class DashboardUnitCountOfflineCommand extends Command
{
    protected $signature = 'dashboard_unit_count_offline:update {unit_id?}';
    protected $description = 'Cập nhật tổng số khoá tập trung (Dashboard đơn vị). Chạy lúc 23h (0 23 * * *)';
    ...
    public function handle()
    {
        ...
        foreach ($units as $unit){
            ...
            $model = DashboardUnitCountOffline::firstOrNew([
                'unit_id' => $unit->id,
            ]);
