...
@section('page_title', trans('lacategory.training_cost'))
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" data-field="type_cost_name">{{ trans('lacategory.fee_type') }}</th>
            ...
            <form action="" method="post" class="form-ajax" id="form_save" onsubmit="return false;">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="body_modal">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 control-label">
                                <label>{{ trans('lacategory.fee_type') }}<span class="text-danger">*</span></label>
                            </div>
                            <div class="col-md-7" id="type_costs">
                                <select name="type" id="type" class="form-control select2" data-placeholder="{{ trans('lacategory.fee_type') }}" required>
                                    <option value=""></option>
