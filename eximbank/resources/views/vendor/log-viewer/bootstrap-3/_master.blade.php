...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/maxcdn_v3_bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/maxcdn_v4.4.0_font-awesome.min.css') }}">
    <link href='{{ asset('css/font_Montserrat_400_700_Source_Sans_Pro_400_600.css') }}' rel='stylesheet' type='text/css'>
    <style>
        html {
            position: relative;
            min-height: 100%;
    ...
    <!--[if lt IE 9]>
    <script src="{{ asset('js/oss_maxcdn_v3.7.2_html5shiv.min.js') }}"></script>
    <script src="{{ asset('js/oss_maxcdn_v1.4.2_respond.min.js') }}"></script>
    <![endif]-->
</head>
<body>
    {{-- Navbar --}}
    ...
    {{-- Scripts --}}
    <script src="{{ asset('js/ajax_googleapis_v1.11.3_jquery.min.js') }}"></script>
    <script src="{{ asset('js/maxcdn_v3.3.5_bootstrap.min.js') }}"></script>
    <script src="{{ asset('js/cdnjs_cloudflare_v2.3.0_Chart.min.js') }}"></script>
    <script>
