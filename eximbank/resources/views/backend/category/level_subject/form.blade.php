...
<div role="main">
    ...
    <form method="post" action="{{ route('backend.category.level_subject.save') }}" class="form-validate form-ajax" role="form" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                <div class="btn-group act-btns">
                    ...
                    @endcan
                    <a href="{{ route('backend.category.level_subject') }}" class="btn"><i class="fa fa-times-circle"></i> {{ trans('labutton.cancel') }}</a>
                </div>
            </div>
        </div>
        <div class="clear"></div>
