    ...
    $('button[name=btnCreate]').on('click',function (e) {
        ...
        Swal.fire(
            ...
            html:
                ...
                '</div>'+
                '<div class="form-group row">' +
                    '<div class="col-md-4" stye ="vertical-align:middle"><label>File {{ trans("laprofile.attach") }}</label></div>' +
                    '<div class="col-md-8">' +
                ...
                '</div>'+
                '<div class="form-group row">' +
                    '<div class="col-md-4" stye ="vertical-align:middle"><label>{{ trans("latraining.note") }}</label></div>' +
                    '<div class="col-md-8">' +
