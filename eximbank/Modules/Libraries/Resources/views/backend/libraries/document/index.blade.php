...
@section('page_title', trans('lamenu.document'))
        ...
        <div class="row">
            <div class="col-md-12 form-inline">
                <form class="form-inline w-100 form-search mb-3" id="form-search">
                    <input type="text" name="search" class="form-control w-30" placeholder="{{ trans('lalibrary.documentation_source') }}">
                    <div class="w-24">
            ...
            <div class="col-md-12 text-right act-btns">
                <div class="pull-right">
                    @can('libraries-document-edit')
                        <div class="btn-group">
                            <a href="{{ route('module.document.tree') }}" class="btn">
                    ...
                    @endcan
                    <div class="btn-group">
                        <a class="btn" href="{{ route('module.libraries.document.export') }}"><i class="fa fa-download"></i> {{ trans('labutton.export') }}</a>
                        @can('libraries-document-create')
                            <a href="{{ route('module.libraries.document.create') }}" class="btn"><i class="fa fa-plus-circle"></i> {{ trans('labutton.add_new') }}</a>
                        @endcan
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-field="name_author" data-align="center" data-width="20%">{{ trans('lalibrary.drafting_source') }}</th>
                    <th data-field="category_parent_name">{{trans("backend.document_category")}}</th>
