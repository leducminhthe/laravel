    ...
    <table id="bootstraptable" class="tDefault table table-hover table-bordered bootstrap-table" data-url="{{route('module.report.getData')}}">
        <thead>
            <tr class="tbl-heading">
                <th data-formatter="index_formatter" data-align="center" rowspan="2" data-width="1%">{{ trans('latraining.stt') }}</th>
                <th data-field="title_name" rowspan="2">{{ trans('latraining.title') }}</th>
                <th colspan="3">{{trans('backend.number_candidates')}}</th>
            </tr>
            <tr class="tbl-heading">
                <th data-field="list" data-align="center">{{trans('backend.list')}}</th>
                <th data-field="reality" data-align="center">{{trans('backend.reality')}}</th>
...
<script src="{{asset('styles/module/report/js/bc21.js')}}" type="text/javascript"></script>
