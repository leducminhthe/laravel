...
@section('page_title', trans('lamenu.coaching_mentor_method'))
...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-right act-btns">
                <div class="pull-right">
                    @can('coaching-mentor-method-create')
                    <div class="btn-group">
                    ...
                    <div class="btn-group">
                        ...
                        @endcan
                        @can('coaching-mentor-method-delete')
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="btn-group act-btns">
                            @canany(['coaching-mentor-method-create', 'coaching-mentor-method-edit'])
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('module.coaching_mentor_method.getdata') }}',
            remove_url: '{{ route('module.coaching_mentor_method.remove') }}',
        });
        ...
        function changeStatus(id, status) {
            ...
            $.ajax({
                url: "{{ route('module.coaching_mentor_method.update_status') }}",
                type: 'post',
                data: {
                    ids: ids,
                    status: status
        ...
        function edit(id){
            ...
            $.ajax({
                url: "{{ route('module.coaching_mentor_method.edit') }}",
                type: 'post',
                data: {
                    id: id,
                }
        ...
        function save(event) {
            ...
            $.ajax({
                url: "{{ route('module.coaching_mentor_method.save') }}",
                type: 'post',
                data: {
                    'id': id,
                    'code': code,
