...
class BC31Export implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize,  WithEvents, WithStartRow, WithDrawings
{
    use Exportable;
    protected $index = 0;
    protected $count = 0;
    ...
    {
        $query = BC31::sql($this->title_id, $this->unit_id, $this->user_id, $this->year);
    ...
    public function headings(): array
    {
        ...
        return [
            ...
            [],
            [],
            ['BÁO CÁO TỔNG GIỜ HỌC CỦA HỌC VIÊN'],
            [],
            $colHeader
        ];
    }
