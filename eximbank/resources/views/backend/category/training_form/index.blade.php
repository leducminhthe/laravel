...
@section('page_title', trans('lacategory.training_form'))
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-field="training_type_name">{{ trans('lacategory.training_type') }}</th>
            ...
            <form action="" method="post" class="form-ajax" id="form_save" onsubmit="return false;">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="body_modal">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 control-label">
                                <label for="name">{{ trans('lacategory.training_type') }}<span class="text-danger">*</span></label>
                            </div>
                            <div class="col-md-7" id="training_type">
                                <select name="training_type_id" id="training_type_id" class="form-control select2" data-placeholder="{{ trans('lacategory.training_type') }}">
