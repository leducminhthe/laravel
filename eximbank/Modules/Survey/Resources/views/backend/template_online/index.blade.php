...
@section('content')
                ...
                <div class="pull-right">
                    <div class="btn-group">
                        @can('survey-template-create')
                            ...
                            <a href="{{ route('module.survey.template_online.create') }}" class="btn"><i class="fa fa-plus-circle"></i> {{ trans('labutton.add_new') }}</a>
                        @endcan
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('module.survey.template_online.getdata') }}',
            remove_url: '{{ route('module.survey.template_online.remove') }}'
        });
        ...
        $('.copy').on('click', function () {
            ...
            $.ajax({
                url: '{{ route('module.survey.template.copy_template_online') }}',
                type: 'post',
                data: {
                    ids: ids,
                }
