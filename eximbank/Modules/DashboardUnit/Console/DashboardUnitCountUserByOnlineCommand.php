...
use Modules\DashboardUnit\Entities\DashboardUnitCountUserByOnline;

class DashboardUnitCountUserByOnlineCommand extends Command
{
    protected $signature = 'dashboard_unit_count_user_by_online:update';
    protected $description = 'Cập nhật tổng số CBNV KH Online (Dashboard đơn vị). Chạy lúc 23h (0 23 * * *)';
    ...
    public function handle()
    {
        ...
        foreach ($units as $unit){
            ...
            $model = DashboardUnitCountUserByOnline::firstOrNew([
                'unit_id' => $unit->id,
                'year' => $year
            ]);
