...
use Modules\Offline\Entities\OfflineCourseActivityXapi as ActivityXapi;

class UnzipXapi extends Command
{
    protected $signature = 'offline:unzip-xapi';
    ...
    public function handle() {
        $query = ActivityXapi::from('offline_course_activity_xapi AS a')
            ->whereNotExists(function (Builder $builder) {
                $builder->select(['id'])
                    ->from('offline_xapi AS b')
