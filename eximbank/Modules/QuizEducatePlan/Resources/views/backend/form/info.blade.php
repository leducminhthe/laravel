<form method="post" action="{{ route('module.quiz_educate_plan.save',["idsg"=>$idsg]) }}" class="form-validate form-ajax" role="form" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-9">
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select name="quiz_template_id" id="quiz_template_id" class="form-control select2" data-placeholder="-- Chọn bộ đề --">
                        <option value=""></option>
