        ...
        <div class="row wrapped_history">
            <div class="col-12 col-md-4 mt-2">
                @foreach ($get_activity_courses as $key_history => $get_activity_quiz_scorm)
                    ...
                    @elseif ($get_activity_quiz_scorm->activity_id == 7)
                        @php
                            $quiz_id = \Modules\Offline\Entities\OfflineActivityQuiz::find($get_activity_quiz_scorm->subject_id, ['quiz_id'])->quiz_id;
                            $part =  \Modules\Quiz\Entities\QuizPart::where('quiz_id', '=', $quiz_id)
...
<script>
    ...
    function opend_history_scorm(id, key) {
        ...
        var url = "{{ route('module.offline.attempts', ':id') }}";
