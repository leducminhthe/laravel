...
class ExportDashboardUserQuiz implements WithMultipleSheets
{
    use Exportable;
    ...
    public function sheets(): array
    {
        ...
        $sheet[] = new ExportDashboardUserQuizSheet1($this->type, $this->unit_user, $this->child_arr, $this->area, $this->unit_type, $this->unit, $this->start_date, $this->end_date);

        $sheet[] = new ExportDashboardUserQuizSheet2($this->type, $this->unit_user, $this->child_arr, $this->area, $this->unit_type, $this->unit, $this->start_date, $this->end_date);
