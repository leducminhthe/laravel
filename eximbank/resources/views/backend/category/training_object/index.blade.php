...
@section('page_title', @trans('lacategory.training_object_group') )
...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right act-btns">
                <div class="pull-right">
                    @can('category-training-object-edit')
                        <div class="btn-group">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="btn-group act-btns">
                            @canany(['category-training-object-create', 'category-training-object-edit'])
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('backend.category.training-object.getdata') }}',
            remove_url: '{{ route('backend.category.training-object.remove') }}',
            sort_name: 'id'
        });
        ...
        function changeStatus(id,status) {
            if (id && !status) {
                ...
                if (ids.length <= 0) {
                    show_message('chọn ít nhất 1 {{ trans("lacategory.training_object_group") }}', 'error');
                    return false;
                }
            }
            $.ajax({
                url: "{{ route('backend.category.training-object.ajax_isopen_publish') }}",
                type: 'post',
                data: {
                    ids: ids,
                    status: status
        ...
        function edit(id){
            ...
            $.ajax({
                url: "{{ route('backend.category.training-object.edit') }}",
                type: 'post',
                data: {
                    id: id,
                }
        ...
        function save(event) {
            ...
            $.ajax({
                url: "{{ route('backend.category.training-object.save') }}",
                type: 'post',
                data: {
                    'name': name,
                    'code': code,
        ...
        function create() {
            ...
            $("input[name=id]").val('');
            $("input[name=code]").val('');
            $('#exampleModalLabel').html('Thêm đối tượng đào tạo');
            $('#modal-popup').modal();
        }
    </script>
@endsection
