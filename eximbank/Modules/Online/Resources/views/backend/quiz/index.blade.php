...
@section('content')
                ...
                <div class="pull-right">
                    <div class="btn-group">
                        @if ($course->lock_course == 0)
                            ...
                            <a href="{{ route('module.online.quiz.create', ['course_id' => $course_id, 'quiz_type_by_offline' => 'register_quiz_id']) }}" class="btn">
                                <i class="fa fa-plus-circle"></i> Thi trước ghi danh
                            </a>
                            @endif
                            <a href="{{ route('module.online.quiz.create', ['course_id' => $course_id]) }}" class="btn">
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-formatter="report_formatter" data-align="center" data-width="5%">{{trans('latraining.report')}}</th>
                </tr>
            </thead>
        </table>
    </div>
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            remove_url: '{{ route('module.online.quiz.remove', ['course_id' => $course_id]) }}',
        });
    </script>
@endsection
