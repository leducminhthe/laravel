...
@section('breadcrumb')
    <div class="ibox-content forum-container">
        <h2 class="st_title"><i class="uil uil-apps"></i>
            ...
            <i class="uil uil-angle-right"></i>
            <a href="{{ route('backend.category.training-type') }}">{{ trans('backend.training_type') }}</a>
            <i class="uil uil-angle-right"></i>
...
<div role="main">
    ...
    <form method="post" action="{{ route('backend.category.training-type.save') }}" class="form-validate form-ajax" role="form" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                <div class="btn-group act-btns">
                    ...
                    @endcanany
                    <a href="{{ route('backend.category.training-type') }}" class="btn"><i class="fa fa-times-circle"></i> {{ trans('labutton.cancel') }}</a>
                </div>
            </div>
        </div>
        <div class="clear"></div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                <div class="col-sm-3 control-label">
                                    <label>{{ trans('backend.training_type_code') }}<span class="text-danger">*</span></label>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3 control-label">
                                    <label>{{ trans('backend.training_type_name') }}<span class="text-danger">*</span></label>
                                </div>
                                <div class="col-md-6">
