                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <select name="training_program_id"
                                    id="training_program"
                                    class="form-control select2 load-training-program"
                                    data-placeholder="{{ trans('latraining.training_program') }}">
                            </select>
                            <select name="level_subject_id"
                                    id="level_subject"
                                    class="form-control select2 load-level-subject"
                                    data-placeholder="{{ trans('latraining.type_subject') }}">
                            </select>
                            <select name="subject_id"
                                    id="subject"
                                    class="form-control select2 load-subject"
                                    data-training-program=""
                                    data-level-subject=""
                                    data-placeholder="{{ trans('latraining.subject') }}">
                            </select>
