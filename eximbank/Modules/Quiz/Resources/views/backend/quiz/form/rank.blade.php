    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group row">
                ...
                <span class="d-flex align-items-center">{{ trans("backend.to") }}</span>
                <div class="col-sm-2">
                ...
                <thead>
                    <tr>
                        ...
                        @if($model->quiz_type != 1)
                            @if (!isset($result))
                                <th data-field="action" data-formatter="action_rank_formatter" data-align="center" data-width="5%">{{trans('backend.action')}}</th>
                            @endif
                        @endif
                    </tr>
                </thead>
