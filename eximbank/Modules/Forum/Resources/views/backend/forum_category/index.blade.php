        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right act-btns">
                <div class="pull-right">
                    <div class="btn-group">
                        @can('forum-create')
                            <a href="{{ route('module.forum.category.filter') }}" class="btn"><i class="fa fa-plus-circle"></i> {{ trans('labutton.filter_word') }}</a>
                        @endcan
                    </div>
                    @can('forum-status')
                        <div class="btn-group">
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-field="status" data-width="10%" data-formatter="totalForums" data-align="center" >{{ trans('laforums.approve') }}</th>
                    <th data-field="status" data-width="5%" data-formatter="status_formatter" data-align="center" >{{ trans('laforums.status') }}</th>
                    <th data-field="action" data-width="5%" data-align="center" data-formatter="action_formatter">{{ trans('laforums.posts') }}</th>
                </tr>
            </thead>
        </table>
    </div>
