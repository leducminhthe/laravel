...
class CreateElActivityXapiScoresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_activity_xapi_scores', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_activity_xapi_scores');
    }
}
