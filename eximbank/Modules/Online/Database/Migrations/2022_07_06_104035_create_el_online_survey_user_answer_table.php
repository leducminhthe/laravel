...
class CreateElOnlineSurveyUserAnswerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_online_survey_user_answer', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('survey_user_question_id')->index()->comment('id table el_online_survey_user_question');
    ...
    {
        Schema::dropIfExists('el_online_survey_user_answer');
    }
}
