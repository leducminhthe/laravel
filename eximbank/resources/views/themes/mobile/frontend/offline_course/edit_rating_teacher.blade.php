...
@section('content')
    <div class="container-fluid sa4d25 p-1 mt-2" id="rating_level">
        <input type="hidden" name="teaching_organization_id" value="{{ $organization_user->id }}">
        <input type="hidden" name="template_id" value="{{ $organization_user->template_id }}">
                                                                ...
                                                                @foreach($answers as $ans_key => $answer)
                                                                    ...
                                                                    <th class="text-center border-top-0 w-auto">
                                                                        ...
                                                                        <label for="is_check{{$answer->answer_id}}_teacher{{ $teacher->id }}" class="mb-0">
                                                                            <img src="/images/{{ $answer->answer_id <= $question->answer_essay ? 'heart_check.png' : 'heart_1.png' }}" class="image_choose img_{{ $ans_key }}" height="20px" width="20px" onclick="checkRankQuestionTeacher({{ $ans_key }},{{ $question->question_id }}, {{ $teacher->id }})">
                                                                            <br>
                                                                            {{ $answer->answer_name }}
                                                                        </label>
                                                                    </th>
                                                            ...
                                                            @foreach($answers as $ans_key => $answer)
                                                                ...
                                                                <th class="text-center border-top-0 w-auto">
                                                                    ...
                                                                    <label for="is_check{{$answer->answer_id}}" class="mb-0">
                                                                        <img src="/images/{{ $answer->answer_id <= $question->answer_essay ? 'heart_check.png' : 'heart_1.png' }}" class="image_choose img_{{ $ans_key }}" height="20px" width="20px" onclick="checkRankQuestion({{ $ans_key }},{{ $question->question_id }})">
                                                                        <br>
                                                                        {{ $answer->answer_name }}
                                                                    </label>
                                                                </th>
