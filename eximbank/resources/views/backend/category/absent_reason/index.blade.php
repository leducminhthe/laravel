...
@section('page_title', @trans('lacategory.absent_reason'))
...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right act-btns">
                <div class="pull-right">
                    @can('category-absent_reason-edit')
                        <div class="btn-group">
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('backend.category.absent-reason.getdata') }}',
            remove_url: '{{ route('backend.category.absent-reason.remove') }}',
            sort_name: 'id'
        });
        ...
        function changeStatus(id,status) {
            ...
            $.ajax({
                url: "{{ route('backend.category.absent-reason.ajax_isopen_publish') }}",
                type: 'post',
                data: {
                    ids: ids,
                    status: status
        ...
        function edit(id){
            ...
            $.ajax({
                url: "{{ route('backend.category.absent-reason.edit') }}",
                type: 'post',
                data: {
                    id: id,
                }
        ...
        function save(event) {
            ...
            $.ajax({
                url: "{{ route('backend.category.absent-reason.save') }}",
                type: 'post',
                data: {
                    'name': name,
                    'code': code,
