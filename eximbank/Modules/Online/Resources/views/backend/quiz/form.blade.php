    ...
    @if($model->id)
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <a href="{{ route('module.online.quiz.question', ['course_id' => $course_id, 'id' => $model->id]) }}" class="btn"> <i class="fa fa-question-circle"></i> {{ trans('latraining.question') }}</a>
            </div>
        </div>
        <p></p>
    @endif
    <div class="tPanel">
        <ul class="nav nav-pills mb-4" role="tablist" id="mTab">
            ...
            @if($model->id)
                ...
                {{-- <li class="nav-item"><a href="#promotion" class="nav-link @if($tabs == 'promotion') active @endif" role="tab" data-toggle="tab">{{ trans('latraining.reward_points') }}</a></li> --}}
            @endif
        </ul>
