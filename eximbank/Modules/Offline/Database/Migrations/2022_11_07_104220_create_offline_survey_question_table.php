...
class CreateOfflineSurveyQuestionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('offline_survey_question', function (Blueprint $table) {
            $table->integer('id');
    ...
    {
        Schema::dropIfExists('offline_survey_question');
    }
}
