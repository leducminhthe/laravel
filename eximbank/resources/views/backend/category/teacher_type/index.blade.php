...
@section('page_title', trans('lacategory.teacher_type'))
...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-right act-btns">
                <div class="pull-right">
                    @can('category-teacher-type-edit')
                        <div class="btn-group">
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" data-field="code" data-formatter="name_formatter">{{ trans('lacategory.name') }}</th>
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('backend.category.teacher_type.getdata') }}',
            remove_url: '{{ route('backend.category.teacher_type.remove') }}'
        });
        ...
        function changeStatus(id,status) {
            ...
            $.ajax({
                url: "{{ route('backend.category.teacher_type.ajax_isopen_publish') }}",
                type: 'post',
                data: {
                    ids: ids,
                    status: status
        ...
        function edit(id){
            ...
            $.ajax({
                url: "{{ route('backend.category.teacher_type.edit') }}",
                type: 'post',
                data: {
                    id: id,
                }
        ...
        function save(event) {
            ...
            $.ajax({
                url: "{{ route('backend.category.teacher_type.save') }}",
                type: 'post',
                data: {
                    'name': name,
                    'code': code,
        ...
        function create() {
            ...
            $("input[name=id]").val('');
            $("input[name=code]").val('');
            $('#exampleModalLabel').html('Thêm loại giảng viên');
            $('#modal-popup').modal();
        }
    </script>
@endsection
