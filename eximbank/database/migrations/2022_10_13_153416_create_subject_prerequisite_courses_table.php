...
class CreateSubjectPrerequisiteCoursesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('subject_prerequisite_courses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('subject_prerequisite_courses');
    }
}
