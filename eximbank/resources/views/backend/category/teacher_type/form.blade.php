        ...
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                <div class="btn-group act-btns">
                    ...
                    @endcanany
                    <a href="{{ route('backend.category.teacher_type') }}" class="btn"><i class="fa fa-times-circle"></i> {{ trans('labutton.cancel') }}</a>
                </div>
            </div>
        </div>
        <div class="clear"></div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label class="radio-inline"><input type="radio" name="status" value="0" @if($model->status == 0) checked @endif>{{ trans('latraining.disable') }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
