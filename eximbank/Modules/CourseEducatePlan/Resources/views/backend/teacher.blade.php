...
@section('breadcrumb')
    <div class="ibox-content forum-container">
        <h2 class="st_title"><i class="uil uil-apps"></i>
            ...
            <a href="{{ route('module.course_educate_plan.management') }}">Kế hoạch đào tạo tháng</a>
            <i class="uil uil-angle-right"></i>
            <a href="{{ route('module.course_educate_plan.edit', ['id' => $course->id]) }}">{{ $page_title }}</a>
            <i class="uil uil-angle-right"></i>
...
@section('content')
        ...
        <div class="row">
            @if($course->id)
                <div class="col-md-12 text-center">
                    <a href="{{ route('module.course_educate_plan.edit', ['id' => $course->id]) }}" class="btn">
    ...
    <div class="modal fade" id="modal-import" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <form action="{{ route('module.course_educate_plan.save_teacher', ['id' => $course->id]) }}" method="post" class="form-ajax">
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('module.course_educate_plan.get_teacher', ['id' => $course->id]) }}',
            remove_url: '{{ route('module.course_educate_plan.remove_teacher', ['id' => $course->id]) }}'
        });
