    ...
    @php
        $breadcum= [
            [
                ...
                'url' => route('backend.slider_outside')
            ],
            [
                'name' => $page_title,
                'url' => ''
    ...
    <div role="main">
        <div class="tPanel">
            <div class="tab-content">
                <form method="post" action="{{ route('backend.slider_outside.save') }}" class="form-validate form-ajax" role="form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-right">
                            <div class="btn-group act-btns">
                                ...
                                <a href="{{ route('backend.slider_outside') }}" class="btn"><i class="fa fa-times-circle"></i> {{ trans('labutton.cancel') }}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3 control-label">
                            <label for="url">{{ trans('lasetting.url') }} <span class="text-danger">*</span></label>
                        </div>
                        <div class="col-sm-6">
