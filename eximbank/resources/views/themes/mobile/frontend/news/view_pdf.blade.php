...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('styles/vendor/pdf_view/viewer.css') }}">


    <!-- This snippet is used in production (included from viewer.html) -->
    <link rel="resource" type="application/l10n" href=" {{ asset('styles/vendor/pdf_view/locale/locale.properties') }}">
    <script src="{{ asset('styles/vendor/pdf_view/build/pdf.js') }}"></script>
    <script>
        var path = '{{ $path }}';
        var url = "{{ asset('styles/vendor/pdf_view/build/pdf.worker.js') }}";
    </script>

    <script src="{{ asset('styles/vendor/pdf_view/viewer.js') }}"></script>
</head>

<body tabindex="1" class="loadingInProgress">
<a href="javascript:void(0)" onclick="window.history.back(); return false;" class="mt-3 text-white">
    <img src="{{ asset('images/back.svg') }}" alt="" width="30">
</a>
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
            <div id="secondaryToolbarButtonContainer">
                ...
                <button id="scrollVertical" class="secondaryToolbarButton scrollModeButtons scrollVertical toggled" title="Use Vertical Scrolling"
                        tabindex="62" data-l10n-id="scroll_vertical">
                ...
                <button id="scrollHorizontal" class="secondaryToolbarButton scrollModeButtons scrollHorizontal" title="Use Horizontal Scrolling"
                        tabindex="63" data-l10n-id="scroll_horizontal">
