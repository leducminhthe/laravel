        ...
        <div class="tPanel">
            ...
            <div class="tab-content">
                <div id="base" class="tab-pane active">
                    @include('libraries::backend.libraries.document.form.info')
                </div>
                @if($model->id)
                    <div id="object" class="tab-pane">
                        @include('libraries::backend.libraries.document.form.object')
                    </div>
                    <div id="reward-points" class="tab-pane">
                        @include('libraries::backend.libraries.reward_points',['type' => 3])
                    </div>
                @endif
            </div>
        </div>
