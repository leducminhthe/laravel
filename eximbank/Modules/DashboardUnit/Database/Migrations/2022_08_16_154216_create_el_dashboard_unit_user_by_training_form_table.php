...
class CreateElDashboardUnitUserByTrainingFormTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_dashboard_unit_user_by_training_form', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_dashboard_unit_user_by_training_form');
    }
}
