...
class CreateElOnlineRegisterViewTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_online_register_view', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_online_register_view');
    }
}
