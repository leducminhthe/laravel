<div class="modal fade modal-add-object" id="myModal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="post" action="{{ route('module.offline.rating_level.save_object', ['course_id' => $course->id, 'id' => $offline_rating_level->id]) }}" class="form-ajax" id="form-rating-level-object" data-success="submit_success_rating_level_object">
                <div class="modal-header">
                    <h4 class="modal-title">Thêm đối tượng {{ $offline_rating_level->rating_name }}</h4>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <label class="radio-inline">
                                <input type="radio" name="object_rating" class="radio-object-rating" value="1" {{ $offline_rating_level->object_rating == 1 ? 'checked' : '' }}> Lớp học
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="object_rating" class="radio-object-rating" value="2" {{ $offline_rating_level->object_rating == 2 ? 'checked' : '' }}> {{ trans('latraining.student') }}
                            </label>
                        </div>
                    </div>
                    <div class="form-group row">
...
<script type="text/javascript">
    ...
    var object_rating_result = '{{ $offline_rating_level->object_rating }}';
    if(object_rating_result == 1){
        $('#object_type_2').hide();
        $('#object_type_3').hide();
    }
    if(object_rating_result == 3){
        $('#object_type_2').hide();
        $('#object_type_3').hide();
        $('#object_type_4').hide();
    }
    ...
    $('.radio-object-rating').on('click', function () {
        ...
        if (object_rating == 1){
        ...
        }else if (object_rating == 3){
            $('#object_type_1').show();
            $('#object_type_2').hide();
            $('#object_type_3').hide();
            $('#object_type_4').hide();

            $('#object_type_1 input[name=object_type\\[\\]]').prop("checked", true);
            ...
            $('#object_type_4 input[name=object_type\\[\\]]').prop("checked", false);
