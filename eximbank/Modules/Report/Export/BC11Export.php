...
class BC11Export implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize,  WithEvents, WithStartRow, WithDrawings
{
    ...
    public function headings(): array
    {
        ...
        return [
            ...
            ['Hình thức đào tạo', '', $this->course_type == 2 ? 'Tập trung' : 'Trực tuyến'],
            ['Thời lượng', '', $course_time ? $course_time . ' ' . $time_unit : ''],
            [trans('latraining.start_date'), '', get_date($course->start_date)],
            [trans('latraining.end_date'), '', get_date($course->end_date)],
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->mergeCells('C15:F15');
                $event->sheet->getDelegate()->mergeCells('C16:F16');
                $event->sheet->getDelegate()->mergeCells('C17:F17');
                ...
                $event->sheet->getDelegate()->mergeCells('A16:B16');
                $event->sheet->getDelegate()->mergeCells('A17:B17');

                $event->sheet->getDelegate()->getStyle('A7:F17')->applyFromArray([
                    'borders' => [
                        'allBorders' => [
                ...
                $event->sheet->getDelegate()->getStyle('C8:F17')->applyFromArray([
                    'alignment' => [
