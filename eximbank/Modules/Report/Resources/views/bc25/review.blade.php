    ...
    <table id="bootstraptable" class="tDefault table table-hover table-bordered bootstrap-table" data-url="{{route('module.report.getData')}}">
        <thead>
            <tr class="tbl-heading">
                ...
                <th data-field="quantity" data-align="center">{{ trans('backend.quantity') }}</th>
                <th data-field="date" data-align="center">{{trans('backend.date_held')}}</th>
            </tr>
        </thead>
    </table>
</div>
...
<script src="{{asset('styles/module/report/js/bc25.js')}}" type="text/javascript"></script>
