$(function () {
  ...
  QUnit.test('should toggle aria-pressed on buttons with container', function (assert) {
    ...
    var groupHTML = '<div class="btn-group" data-toggle="buttons">' +
        ...
        '<button class="btn" type="button">Two</button>' +
      '</div>'
  ...
  QUnit.test('should not add aria-pressed on labels for radio/checkbox inputs in a data-toggle="buttons" group', function (assert) {
    assert.expect(2)
    var groupHTML = '<div class="btn-group" data-toggle="buttons">' +
      '<label class="btn"><input type="checkbox" autocomplete="off"> Checkbox</label>' +
      '<label class="btn"><input type="radio" name="options" autocomplete="off"> Radio</label>' +
      '</div>'
    var $group = $(groupHTML).appendTo('#qunit-fixture')
  ...
  QUnit.test('should handle disabled attribute on non-button elements', function (assert) {
    ...
    var groupHTML = '<div class="btn-group disabled" data-toggle="buttons" aria-disabled="true" disabled>' +
      '<label class="btn disabled" aria-disabled="true" disabled>' +
