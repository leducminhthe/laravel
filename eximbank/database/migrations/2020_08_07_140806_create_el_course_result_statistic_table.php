...
class CreateElCourseResultStatisticTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_course_result_statistic', function (Blueprint $table) {
            ...
            $table->integer('result')->comment('1 đạt 2 rớt');
        });
    }
    ...
    {
        Schema::dropIfExists('el_course_result_statistic');
    }
}
