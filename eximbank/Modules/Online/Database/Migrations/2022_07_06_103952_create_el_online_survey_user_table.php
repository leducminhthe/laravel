...
class CreateElOnlineSurveyUserTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_online_survey_user', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_online_survey_user');
    }
}
