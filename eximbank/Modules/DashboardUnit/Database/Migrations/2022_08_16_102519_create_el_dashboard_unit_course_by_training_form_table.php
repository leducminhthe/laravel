...
class CreateElDashboardUnitCourseByTrainingFormTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_dashboard_unit_course_by_training_form', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('unit_id')->index();
            $table->string('unit_code')->nullable();
            $table->integer('training_form_id')->nullable()->index();
    ...
    {
        Schema::dropIfExists('el_dashboard_unit_course_by_training_form');
    }
}
