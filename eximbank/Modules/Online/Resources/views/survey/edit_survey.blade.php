...
@section('content')
            ...
            <div class="_14d25">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <form action="{{ route('module.online.survey.user.save') }}" method="post" class="form-validate form-ajax" role="form" enctype="multipart/form-data" data-success="submit_success_online_survey_user">
    ...
    <script>
        function submit_success_online_survey_user(form){
            console.log(form);
            // top.location.href = "{{ route('module.online.detail_online', [$course_id]) }}";
        }
