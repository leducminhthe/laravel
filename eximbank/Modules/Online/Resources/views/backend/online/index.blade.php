...
@section('content') --}}
    <div role="main">
            ...
            <div class="col-md-12 act-btns">
                <div class="pull-right">
                    ...
                    <div class="wrraped_online text-right">
                        {{--  <div class="btn-group">
                            <a href="{{ route('module.online.course_for_offline') }}" class="btn">
                                Khóa dành cho tập trung
                            </a>
                        </div>  --}}
                        <div class="btn-group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="min-width: 12rem;">
                                    ...
                                    @canany(['online-course-create', 'online-course-edit'])
                                        <a class="dropdown-item p-1" onclick="lockCourse(0,1)" data-status="1" style="cursor: pointer;">
                                            <svg class="w_15" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                <g>
                                                    <g>
                                                        <g>
                            ...
                            @can('online-course-create')
                                <a href="{{ route('module.online.create') }}" class="btn"><i class="fa fa-plus-circle"></i> {{ trans('labutton.add_new') }}</a>
                            @endcan
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    ...
                    <th data-field="register_deadline" data-sortable="true" data-align="center" data-width="5%">{{ trans('latraining.register_deadline') }}</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <div class="col-md-7 control-label"> {{ trans('latraining.register') }}</div>
                            <div class="col-md-5">
                                <a class="btn" href="{{ download_template('mau_import_nhan_vien_ghi_danh_nhieu_khoa_hoc.xlsx') }}"><i class="fa fa-download"></i> {{ trans('labutton.import_template') }}</a>
                            </div>
                        </div>
                        {{--  <div class="form-group row">
                            <div class="col-md-7 control-label"> {{ trans('latraining.result') }}</div>
        ...
        <div class="modal fade" id="modal-import-register" tabindex="-1" role="dialog" aria-labelledby="modal-import-register" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <form action="{{ route('module.online.import_register_multiple_course') }}" method="post" class="form-ajax">
                    <div class="modal-content">
                        <div class="modal-header">
        ...
        <div class="modal fade" id="modal-import-result" tabindex="-1" role="dialog" aria-labelledby="modal-import-result" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <form action="{{ route('module.online.import_result_multiple_course') }}" method="post" class="form-ajax">
                    <div class="modal-content">
                        <div class="modal-header">
    ...
    <script type="text/javascript">
        ...
        function status_formatter(value, row, index) {
            ...
            if(row.approved_step && value != 2){
                text_status += `<br> (<a href="javascript:void(0)" data-parent_unit="${row.parent_unit}" data-id="${row.id}" data-model="el_online_course" class="text-success font-weight-bold load-modal-approved-step">${row.approved_step}</a>)`;
            } else if (value == 2) {
                text_status += `<br> (<a href="javascript:void(0)" data-parent_unit="${row.parent_unit}" data-id="${row.id}" data-model="el_online_course" class="text-success font-weight-bold load-modal-approved-step">0/`+ row.count_level_permission_approve +`</a>)`;
            }
            return text_status;
        }
        ...
        function info_formatter(value, row, index) {
            ...
            @can('online-course-register')
                info += '<a href="'+ row.register_url +'" class="btn mb-1" title="{{ trans('latraining.register') }}"><i class="fa fa-user"></i></a>';
            @endcan
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('module.online.backend.getdata') }}',
