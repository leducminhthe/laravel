...
class CreateOfflineActivityScormScoresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('offline_activity_scorm_scores', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('offline_activity_scorm_scores');
    }
}
