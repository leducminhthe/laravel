...
@section('content')
    <div class="container wrapped_info">
        ...
        <form name="frm" action="" id="form-search-online" method="post" autocomplete="off">
            <input type="hidden" name="model_id" id="model_id_1" value="{{ $model_id }}">
            <input type="hidden" name="year_course" id="model_year_course_1" value="{{ $year_course }}">
            <input type="hidden" name="month_course" id="model_month_course_1" value="{{ $month_course }}">
            <input type="hidden" name="status_course" id="model_status_course_1" value="{{ $status_course }}">
            <input type="hidden" name="filter_name" id="model_filter_name_1" value="{{ $filter_name }}">
        </form>
        <div id="bootstraptableOnline" class="">
            <table id="bootstraptable_1" class="tDefault table table-hover table-bordered bootstrap-table" data-url="{{ route('themes.mobile.frontend.dashboard_unit.data_user_online') }}" >
                <thead>
