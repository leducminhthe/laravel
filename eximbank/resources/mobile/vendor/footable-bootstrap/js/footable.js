...
(function ($, F) {
	F.Filtering = F.Component.extend(/** @lends FooTable.Filtering */{
		...
		$create: function () {
			...
			self.$button = $('<button/>', {type: 'button', 'class': 'btn'})
...
(function($, F){
	...
	F.Editing = F.Component.extend(/** @lends FooTable.Editing */{
		 ...
		 */
		$buttonShow: function(){
			return '<button type="button" class="btn footable-show">' + this.showText + '</button>';
		},
		/**
		 ...
		 */
		$buttonAdd: function(){
			return '<button type="button" class="btn footable-add">' + this.addText + '</button> ';
		},
		/**
