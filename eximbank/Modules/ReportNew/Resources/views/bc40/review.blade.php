    ...
    <div class="row m-0">
        <div class="col-md-6">
            <div class="form-group row">
                <div class="col-md-4 pr-1 control-label">
    ...
    <table id="bootstraptable" class="tDefault table table-hover table-bordered bootstrap-table text-nowrap" data-url="{{route('module.report_new.getData')}}">
        <thead>
            <tr class="tbl-heading">
                ...
                <th data-field="course" data-formatter="course_formatter">{{ trans('lamenu.course') }}</th>
                ...
                <th data-field="total_time" data-align="center">{{ trans('lareport.spend_learned_summary') }} (giờ)</th>
