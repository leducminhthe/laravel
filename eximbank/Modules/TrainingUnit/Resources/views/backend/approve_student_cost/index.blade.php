...
@section('content')
    <div role="main">
        ...
        <table class="tDefault table table-hover bootstrap-table">
            <thead>
                <tr>
                    <th data-field="code" data-width="10%">{{trans('latraining.course_code')}}</th>
                    <th data-field="name" data-width="20%" data-formatter="name_formatter">{{trans('latraining.course_name')}}</th>
                    ...
                    <th data-field="count_approved" data-width="5%" data-align="center">{{ trans('latraining.approved_num') }}</th>
                    <th data-field="count_quantity_approved" data-width="5%" data-align="center">{{ trans('latraining.approve_wait_num') }}</th>
                </tr>
            </thead>
        </table>
    </div>
