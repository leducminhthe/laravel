...
@section('content')
            ...
            <thead>
                <tr>
                    ...
                    <th data-sortable="true" data-field="name" data-width="20%" data-formatter="name_formatter">
                        {{ trans('lacategory.unit')}}
                    </th>
                    <th data-sortable="true" data-field="level" data-class="text-center" data-width="10%">{{ trans('lacategory.unit_structure_level') }}</th>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <div class="col-sm-3 pr-0 control-label">
                                                    <label>{{ trans('lacategory.unit_name') }} <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-md-7">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-3 pr-0 control-label">
                                                    <label>{{ trans('lacategory.unit_name') }}(EN) <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-md-7">
    ...
    <script type="text/javascript">
        ...
        var table = new LoadBootstrapTable({
            ...
            url: '{{ route('backend.category.unit_name') }}',
            remove_url: '{{ route('backend.category.unit_name.remove' ) }}',
        });
        ...
        function saveForm(event) {
            ...
            $.ajax({
                url: "{{ route('backend.category.unit_name.save') }}",
                type: 'post',
        ...
        function edit(id){
            ...
            $.ajax({
                url: "{{ route('backend.category.unit_name.edit' ) }}",
                type: 'post',
                data: {
                    id: id,
                }
