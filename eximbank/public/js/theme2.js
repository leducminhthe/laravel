...
var tab = $('#languages_menu_bottom').attr("data-processing"); // LÊN ĐẦU TRANG
...
$('.select2').select2({
  ...
  width: '100%',
  placeholder: function placeholder(params) {
    return {
      id: null,
...
if (tabs != 'survey-react' && check_survey_popup) {
  var update_num_popup = function update_num_popup(survey_id) {
    $.ajax({
