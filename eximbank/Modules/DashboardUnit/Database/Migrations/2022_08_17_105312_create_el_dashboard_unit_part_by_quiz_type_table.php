...
class CreateElDashboardUnitPartByQuizTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_dashboard_unit_part_by_quiz_type', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_dashboard_unit_part_by_quiz_type');
    }
}
