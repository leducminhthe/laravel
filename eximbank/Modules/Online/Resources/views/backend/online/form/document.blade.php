<div class="">
    <form method="post" action="{{ route('module.online.upload_document', [$model->id]) }}" enctype="multipart/form-data" class="form-horizontal form-ajax">
        {{ csrf_field() }}
...
<script type="text/javascript">
    ...
    var table_document = new LoadBootstrapTable({
        ...
        url: '{{ route('module.online.get_data_document',['course_id' => $model->id]) }}',
        remove_url: '{{ route('module.online.remove_document') }}',
