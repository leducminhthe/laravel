...
class CreateElOfflineRatingLevelObjectTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('el_offline_rating_level_object', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('el_offline_rating_level_object');
    }
}
